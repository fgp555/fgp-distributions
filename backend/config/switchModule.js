...
const wardrobe_seed_1 = require("../modules/ivanagb/wardrobe/_seed/wardrobe.seed");
const envs_1 = require("./envs");
const user_entity_1 = require("../auth/entities/user.entity");
const wardrobe_user_entity_1 = require("../modules/ivanagb/wardrobe/entities/wardrobe-user.entity");
...
function selectUserEntity() {
    switch (envs_1.USE_MODULE) {
        case "wardrobe_module":
            return wardrobe_user_entity_1.WardrobeUserEntity;
