...
exports.verifyToken = exports.requireRole = exports.userRol = exports.adminRol = exports.superRol = void 0;
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const error_middleware_1 = require("./error.middleware");
const envs_1 = require("../config/envs");
exports.superRol = ["superadmin"];
exports.adminRol = ["admin", "superadmin"];
exports.userRol = ["user", "admin", "superadmin"];
