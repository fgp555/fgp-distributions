...
__decorate([
    (0, typeorm_1.ManyToOne)(() => wardrobe_user_entity_1.WardrobeUserEntity, (user) => user.wardrobes, { onDelete: "CASCADE" }),
    __metadata("design:type", wardrobe_user_entity_1.WardrobeUserEntity)
