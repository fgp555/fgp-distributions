...
const stat_track_service_1 = require("../service/stat-track.service");
const error_middleware_1 = require("../../../middleware/error.middleware");
const service = new stat_track_service_1.StatService();
class StatController {
    ...
    async getAll(req, res, next) {
        try {
            const { dateFrom, dateTo, sortDate, search, limit, page } = req.query;
            // validar sortDate
            const sort = sortDate === "ASC" || sortDate === "DESC" ? sortDate : "DESC";
            const result = await service.getAll({
                dateFrom: dateFrom,
                dateTo: dateTo,
                sortDate: sort, // ✅ ahora es "ASC" | "DESC"
                search: search || "",
...
//# sourceMappingURL=stat-track.controller.js.map